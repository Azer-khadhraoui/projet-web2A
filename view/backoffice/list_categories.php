...
<section class="side_bar">
        <div class="logo">
            <img src="../frontoffice/images/logoweb.jpg" alt="Logo" />
        ...
        <nav>
            ...
            <li><a href="../backoffice/bs-simple-admin/index.html">Dashboard</a></li>
                ...
                <li><a href="../backoffice/list_categories.php">Checkout Categories</a></li>
                <li><a href="../backoffice/list_products.php">Checkout Products</a></li>
            </ul>
        </nav>
    </section>
